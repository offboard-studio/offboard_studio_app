...
export const GlobalStateComponent = React.createContext<IGlobalStateContextProps | undefined>(undefined);
// Context exposing the global state
export const useGlobalState = () => React.useContext(GlobalState)!;
export const useGlobalStateComponent = () => React.useContext(GlobalStateComponent)!;
