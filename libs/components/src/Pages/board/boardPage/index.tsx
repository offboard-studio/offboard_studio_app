import { AppBar, Avatar, Box, createTheme, Drawer, Tab, Tabs, Toolbar, ThemeProvider, Typography } from '@mui/material';
import React, { Fragment, useState } from 'react';
import ModalContainer from 'react-modal-promise';
import '../../../App.scss';
import '../styles.scss';
import Editor from '../../../core/editor';
import { GlobalState, GlobalStateComponent, IGlobalState } from '../../../core/store';
    ...
    <div className="App">
      <AppBar className="app-bar" position="static" >
        ...
        <Tabs value={tabIndex} onChange={handleTabChange} selectionFollowsFocus >
          <Tab label="Board" />
          <Button color='inherit' onClick={() => { setTabIndexBoard(true); }} startIcon={<SettingsIcon />} />

          <div style={{ flex: 10 }} />
          <Button color='inherit' onClick={buildAndDownload} startIcon={<DownloadingIcon />} />
          <Button color='inherit' onClick={saveProject} startIcon={<CloudDownloadIcon />} />
          <Button color='inherit' onClick={saveProject} startIcon={<CloudUploadIcon />} />
          <div style={{ flex: 1 }} />
      ...
      {tabIndex === 0 && (
        <div style={{ display: 'flex', flexGrow: 1 }}>
          <div className="board-container" style={{ display: 'flex', flexGrow: 1 }}>
      ...
      {tabIndexBoard === true && (
        <BoardSettings editor={editor} onClose={() => {
          navigate('/board');
