import { 
  ...
  const PricingTable = () => {
    ...
    const features = [
      ...
      { name: 'Server storage', values: ['100 GB', '500 GB', '1 TB', 'Unlimited'] },
        ...
        <Box sx={{ px: 4, maxWidth: '1200px', mx: 'auto' }}>
          <Box sx={{ textAlign: 'center', maxWidth: 'xl', mx: 'auto', mb: 4 }}>
            ...
            <Typography variant="body1" sx={{ 
              ...
              Amet minim mollit non deserunt ullam co est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit.
            </Typography>
          </Box>
          ...
          {isDesktop ? (
                    ...
                    <StyledTableRow key={feature.name}>
                      ...
                      {feature.values.map((value, index) => (
                        <TableCell
                          ...
                          align="center"
                          sx={{ 
                            bgcolor: plans[index].popular ? 'grey.900' : 'transparent',
                            color: plans[index].popular ? 'common.white' : 'text.primary'
                          }}
                        >
                          {typeof value === 'boolean' ? (
                            value ? <Check sx={{ fontSize: 24 }} /> : '-'
                          ) : (
                            value
                          )}
                        </TableCell>
                      ...
                      >
                        <Link
                          ...
                          sx={{
                            ...
                            '&:hover': { color: plan.popular ? 'common.white' : 'primary.dark' }
                          }}
                        >
                          Get Started
            ...
            <Box sx={{ 
              ...
              <Grid container spacing={0} sx={{ borderBottom: 1, borderColor: 'divider' }}>
                {plans.map((plan) => (
                  <Grid item xs={3} key={plan.name} sx={{ 
                    textAlign: 'center',
                    borderRight: 1,
                    borderColor: 'divider',
                    py: 2
