...
import { Avatar, Box, Button, Card, CardContent, Chip, Container, Divider, Grid, Typography } from "@mui/material";
      ...
      <Card>
        <CardContent>
          ...
          <Typography variant="body2" mt={1}>
            Passionate frontend developer with 5+ years of experience building responsive and accessible web applications.
          ...
          <Typography variant="body2" color="textSecondary">
            Lead frontend development for multiple client projects. Implemented design systems and component libraries that improved development efficiency by 40%.
          </Typography>
          <Divider sx={{ my: 2 }} />
