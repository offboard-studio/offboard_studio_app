...
export const BoardPage = (): JSX.Element => {
  ...
  const [stateX, setStateX] = useState<IGlobalState>({
  ...
  const getMainContentStyle = useCallback(() => {
    const baseWidth = sidebarState.isCollapsed ? 60 : 80;
    let totalWidth = baseWidth;

    // Add width of active layers
    sidebarState.activeLayers.forEach((layer) => {
  ...
  }, [sidebarState.isCollapsed, sidebarState.activeLayers]);
          ...
          <Toolbar>
            ...
            >
              <IconButton
                ...
                sx={{ mr: 2 }}
              >
                {sidebarState.isCollapsed ? <MenuIcon /> : <MenuOpenIcon />}
              </IconButton>
            </Tooltip>
        ...
        {tabIndex === 0 && (
          ...
          >
            ...
            <Box className="main-content" sx={getMainContentStyle()}>
              ...
              >
                <GlobalState.Provider value={{ stateX, setStateX }}>
                  <Board editor={editor}  />
