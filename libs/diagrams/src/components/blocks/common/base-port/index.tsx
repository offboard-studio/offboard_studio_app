...
const BasePort: React.FC<BasePortProps> = (props) => {
    ...
    // Check if port is defined before using getOptions()
    if (!port) {
        console.error("Port is undefined or null");
        return null; // Return null or some fallback if port is not available
    }
